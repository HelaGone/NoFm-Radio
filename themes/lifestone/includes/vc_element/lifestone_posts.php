<?php
function lifestone_posts_fn() {
    vc_map( array(
        "name" => esc_html__("Blog", 'lifestone'),
        "base" => "lifestone_posts",
        ...
        "params" => array(
            ...
            array(
                'type'          => 'dropdown',
                'holder'        => 'div',
                'heading'       => esc_html__('Display tabs for categories', 'lifestone'),
                'param_name'    => 'is_tab',
                'description'   => esc_html__('Enable this option if you want to display tab', 'lifestone'),
                'admin_label'   => true,
                'value'         => array(
                    esc_html__('Select Option', 'lifestone')  => '',
            ...
            array(
                ...
                "param_name"  => "order_by",
                "description" => __('Select how to sort retrieved products. More at <a href="http://codex.wordpress.org/Class_Reference/WP_Query#Order_.26_Orderby_Parameters">WordPress codex page.</a>', 'lifestone'),
                "value"       => array(
                    esc_html__( 'Select', 'lifestone' ) => '',
...
class WPBakeryShortCode_Lifestone_Posts extends WPBakeryShortCode
{
