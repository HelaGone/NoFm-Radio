...
<section id="sumo_abolengo">
	...
	<section id="section_cuadrilatero" class="section_figure">
		...
		<div class="sumo_texto">
			...
			<p>Productora de eventos culturales y de entretenimiento para necesidades específicas</p>
			<p>Conceptualizamos, desarrollamos y producimos eventos empresariales,<br>
			académicos y personales con una sola premisa:</p>
			<br>
			<p>cada uno es especial porque es tuyo.</p>
			<p>Cuéntanos qué quieres, qué necesitas y diseñamos tu celebración.</p>
		</div>
	</section>
	...
	<section id="section_fina_mezcla" class="section_figure">
		...
		<div class="sumo_texto">
			<p>
				...
				investigación académica o comercial; y todo material sonoro que<br>
				necesites para :
			</p>
			<br>
			<p>
				ambientar eventos – congresos, simposios, encuentros -. También<br> 
				conceptualizamos y realizamos spots y campañas de audio<br>
				para radio e internet.
			</p>
			<br>
			<p>
				Sonorizamos trabajamos, diseñamos ideas.
			</p>
		</div>
	</section>
	...
	<section id="section_we_human" class="section_figure">
		...
		<div class="sumo_texto">
			<p>
				Diseños originales de impresos para diversas aplicaciones textiles.
			</p>
			<br>
			<p>
			...
			<br>
			<p>
				También realizamos trabajos sobre pedido y características especiales.
			</p>
		</div>
	</section>
	...
	<section id="section_hgrafica" class="section_figure">
		...
		<div class="sumo_texto">
			<p>
				Taller de artes gráficas e impresiones multiformato.
			</p>
			<br>
			<p>
	...
	<section id="section_mp" class="section_figure">
		...
		<div class="sumo_texto">
			<p>
				Servicios editoriales multipropósito.
			</p>
			<p>
			...
			<p>
				...
				(sí el diseño va incluido)
			</p>
			<br>
			<p>
				Realizamos manuales de venta, estilo y marca;<br>
				catálogos (impresos y web) y libros personales y de ocasión.
			</p>
			<br>
			<p>
				También: anuarios, boletines y revistas.
			</p>
			<br>
			<p>
				Contamos con un consejo editorial y de arte para asesorías y consultorías.
			</p>
		</div>
	</section>
	...
	<section id="section_tm_miedo" class="section_figure">
		...
		<div class="sumo_texto">
			<p>
				No es una esquina es un vértice.
			</p>
			<br>
			<p>	
				Agencia y productora audiovisual que desarrolla contenidos<br> 
				creativos a partir de la optimización de recursos para potenciar <br>
				resultados.
			</p>
			<br>
			<p>
				Concepción, desarrollo y producción de estrategias comunicativas.
			</p>
		</div>
	</section>
