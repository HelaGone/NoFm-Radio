    ...
    <div id="post-<?php the_ID(); ?>" class="post-article <?php echo esc_attr($postClass); ?>">
        ...
        <div class="post-entry">
            ...
            <div class="post-footer">
                ...
                <?php if(lifestone_tags()) { ?>

                    <div class="post-tag">

                        <h5><?php echo esc_html__('Tags:', 'lifestone'); ?></h5>
                ...
                $postShareOption = lifestone_get_option('lifestone_single_post_share_option', 'off');
                ...
                if($postShareOption == 'on' && lifestone_is_package_activated()){?>
                    ...
                    <div class="post-share">
                        ...
                        <div class="share">
                            ...
                            <?php if(lifestone_is_enabled('lifestone_single_post_share_twitter_option')) {
                            ...
                            <?php if(lifestone_is_enabled('lifestone_single_post_share_google_option')){
                            ...
                            <?php if(lifestone_is_enabled('lifestone_single_post_share_linkedin_option')){
...
<?php if(lifestone_author_info_box()){ ?>
